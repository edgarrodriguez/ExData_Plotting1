...
#Put together the data and use points to print each color

#plot(dtSelectedDates$KeyDateTime,as.numeric(dtSelectedDates$Sub_metering_1),ylab="Energy sub metering",xlab="",type="n")
